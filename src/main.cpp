...
uint256 hashGenesisBlock("0x04f945e781e12fab9c7e0f78938226d27f4df2b73fd937c3741d8033fd0185ed");
...
const string strMessageMagic = "Viata Signed Message:\n";
...
static const int64 nTargetTimespan = 50 * 24 * 60 * 60; // Viata: 1 days
static const int64 nTargetSpacing = 300; // Viata: 5 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Viata miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Viata", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x04f945e781e12fab9c7e0f78938226d27f4df2b73fd937c3741d8033fd0185ed");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1490000000; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 830723;

        if (fTestNet)
        {
            block.nTime    = 1490000000;
            block.nNonce   = 830723;
        }
